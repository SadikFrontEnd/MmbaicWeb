...
class HeroscopesTwo3 extends React.Component {
  render() {
    return (
            ...
            <Row>
              <Col lg="12">
                <div className="scope-1">
                  ...
                  <Row>
                    <Col md="2">
                      <Link to={"/horoscopedetail3/aries"}>
                    ...
                    <Col md="2">
                      <Link to={"/horoscopedetail3/taurus"}>
                        <div className="scope-detail scop-2 mtb-10">
                          <div className="scope-img">
                    ...
                    <Col md="2">
                      <Link to={"/horoscopedetail3/gemini"}>
                        <div className="scope-detail scop-2 mtb-10">
                          <div className="scope-img">
                    ...
                    <Col md="2">
                      <Link to={"/horoscopedetail3/cancer"}>
                        <div className="scope-detail scop-2 mtb-10">
                          <div className="scope-img">
                    ...
                    <Col md="2">
                      <Link to={"/horoscopedetail3/virgo"}>
                        <div className="scope-detail scop-2 mtb-10">
                          <div className="scope-img">
                    ...
                    <Col md="2">
                      <Link to={"/horoscopedetail3/libra"}>
                        <div className="scope-detail scop-2 mtb-10">
                          <div className="scope-img">
                    ...
                    <Col md="2">
                      <Link to={"/horoscopedetail3/scorpio"}>
                        <div className="scope-detail scop-2 mtb-10">
                          <div className="scope-img">
                    ...
                    <Col md="2">
                      <Link to={"/horoscopedetail3/sagittarius"}>
                        <div className="scope-detail scop-2 mtb-10">
                          <div className="scope-img">
                    ...
                    <Col md="2">
                      <Link to={"/horoscopedetail3/capricorn"}>
                        <div className="scope-detail scop-2 mtb-10">
                          <div className="scope-img">
                    ...
                    <Col md="2">
                      <Link to={"/horoscopedetail3/aquarius"}>
                        <div className="scope-detail scop-2 mtb-10">
                          <div className="scope-img">
                    ...
                    <Col md="2">
                      <Link to={"/horoscopedetail3/pisces"}>
                        <div className="scope-detail scop-2 mtb-10">
                          <div className="scope-img">
