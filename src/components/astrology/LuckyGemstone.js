...
class LuckyGemstone extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data1: false,
  ...
  submitHandler = (e) => {
    ...
    console.log("shgdjhg", payload);
    axiosConfig
      .post(`/user/basic_gem_suggestion`, payload)
      .then((response) => {
            ...
            <Row>
              <Col md="12">
                <Card className="mb-50 pt-d">
                  ...
                  <p>
                    Lucky Gemstone is a remarkable branch of Vedic astrology.
                    Collection of the 5 books, written during the period of
                    1939-1952 is called Lucky Gemstone. Written in ancient Urdu
                    language, first time in the history of astrology, Lucky
                    Gemstone introduced a new style of horoscope analysis with
                    quick and affordable remedies. Authorship of the books seems
                    to be disputed.
                  </p>
                  ...
                  <div className="match-bx">
                    <div>
                      <Col md="12">
                        ...
                        <Row>
                          <Col md="4">rerererrer</Col>
                          <Col md="4">rerererrer</Col>
                          <Col md="4">rerererrer</Col>npm
                        </Row>
